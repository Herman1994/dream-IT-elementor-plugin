...
// Register and load the widget
	...
	public function __construct() {
		$widget_ops = array(
			...
			'description' => esc_html__( 'The most recent portfolio on your site.', 'techno' ),
			'customize_selective_refresh' => true,
		);
		parent::__construct( 'em_recent_portfolio_widget', esc_html__( 'EM Recent Portfolio','techno' ), $widget_ops );
			...
			?>		
				...
				<div class="recent-portfolio">
					...
					<?php if( has_post_thumbnail( get_the_ID() ) ){?>
						...
						<?php echo get_the_post_thumbnail( get_the_ID(), 'techno_recent_image' );?>
