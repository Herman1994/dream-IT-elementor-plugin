...
// Register and load the widget
	...
	public function __construct() {
		$widget_ops = array(
			...
			'description' => esc_html__( 'The most recent posts on your site.', 'techno' ),
			'customize_selective_refresh' => true,
		);
		parent::__construct( 'em_recent_post_widget', esc_html__( 'EM Recent Posts','techno' ), $widget_ops );
		...
		while ( $r->have_posts() ){
			...
			<div class="recent-post-item">
				...
				<?php if( has_post_thumbnail( get_the_ID() ) ){?>
					...
					<?php echo get_the_post_thumbnail( get_the_ID(), 'techno-recent-image' );?>
				...
				<div class="recent-post-text">
					<h4><a href="<?php echo esc_url( get_permalink() ); ?>">
						<?php 
							if ( function_exists( 'techno_title' ) ){						
								techno_title(7); 
							} 
						?>										
					</a></h4>					
	...
	public function form( $instance ) {
		...
		?>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'count' ) ); ?>"><?php esc_html_e( 'Number of posts:', 'techno' ); ?></label>
