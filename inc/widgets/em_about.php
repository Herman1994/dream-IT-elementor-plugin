...
add_action('widgets_init', 'techno_about_us_widgets');

if(!function_exists('techno_about_us_widgets')){
	
	function techno_about_us_widgets(){
		
		register_widget('techno_about_us_Widget');
		
	}
}

if(!class_exists('techno_about_us_Widget')){
	
	class techno_about_us_Widget extends WP_Widget {
		...
		public function form($instance){
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php esc_html_e('Title:','techno');?></label>
				<input class="widefat" type="text" id="<?php echo esc_attr($this->get_field_id('title')); ?>" name="<?php echo esc_attr($this->get_field_name('title')); ?>" value="<?php echo esc_attr($instance['title']); ?>" />
			</p>

			<p>
				<label style="display:block;" for="<?php echo esc_attr($this->get_field_id('image_uri')); ?>"><?php esc_html_e('Upload Image:','techno');?></label>
				...
				<a href="#" id="custom_media_button" style="margin-top:10px;" class="button button-primary custom_media_button"><?php esc_html_e('Upload', 'techno'); ?></a>
			</p>

			<p>

				<label for="<?php echo esc_attr($this->get_field_id('content')); ?>"><?php esc_html_e('About Text:','techno');?></label>
				...
				<span> <b><?php esc_html_e('Note:','techno');?></b><?php esc_html_e('use','techno');?> <b> &ltbr&gt </b><?php esc_html_e(' for line break.','techno');?></span>

			</p>
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('address1')); ?>"><?php esc_html_e('Address:','techno');?></label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('telephone')); ?>"><?php esc_html_e('Telephone:','techno');?></label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('email')); ?>"><?php esc_html_e('Email & Web:','techno');?></label>
