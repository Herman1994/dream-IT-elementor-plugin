...
require_once(DREAMIT_DIR_PATH. 'inc/widgets/em_about.php');
require_once(DREAMIT_DIR_PATH. 'inc/widgets/em_recent_post.php');
require_once(DREAMIT_DIR_PATH. 'inc/widgets/em_footer_portfolio.php');
