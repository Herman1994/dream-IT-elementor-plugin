		...
		$this->start_controls_section(
			...
			$this->add_responsive_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .progress_content' => 'text-align: {{VALUE}};',
					],
				]
			);
		$this->end_controls_section();
		...
		$this->start_controls_section(
    		...
    		$this->add_control(
    			...
    			[
    				...
    				'type' => \Elementor\Controls_Manager::COLOR,
    				'selectors' => [
    					'{{WRAPPER}} .work_progress .work_progress-title h2' => 'color: {{VALUE}}',
    				],
    			]
    		);
    		$this->add_group_control(
    			...
    			[
    				...
    				'selector' => '{{WRAPPER}} .work_progress .work_progress-title h2',
    			]
    		);
    		$this->add_control(
    			'description_heading',
    		...
    		$this->add_control(
    			...
    			[
    				...
    				'type' => \Elementor\Controls_Manager::COLOR,
    				'selectors' => [
    					'{{WRAPPER}} .work_progress .work_progress-desc p' => 'color: {{VALUE}}',
    				],
    			]
    		);
    		$this->add_group_control(
    			...
    			[
    				...
    				'label' => __( 'Typography', 'dreamit-elementor-extension' ),
    				'selector' => '{{WRAPPER}} .work_progress .work_progress-desc p',
    			]
    		);
		$this->end_controls_section();
	}
